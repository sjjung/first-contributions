...
## 필요한 변경을 하고 변경사항을 커밋하기

이제 텍스트 편집기로 `Contributors.md` 파일을 열어서, 당신 이름을 추가하세요. 이름을 파일 맨 앞이나 맨 뒤에 추가하지 말고, 중간에 넣으시고, 파일을 저장하세요. 당신은 분명 가벼운 마크업 언어인 Markdown에 익숙할 겁니다.
